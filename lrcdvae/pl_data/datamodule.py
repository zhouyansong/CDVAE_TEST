...
from torch_geometric.loader import DataLoader  # pyg>=2.0  or from torch_geometric.data import DataLoader pyg<2.0

from lrcdvae.common.utils import PROJECT_ROOT
from lrcdvae.common.data_utils import get_scaler_from_data_list
...
@hydra.main(version_base=None, config_path=str(PROJECT_ROOT / "conf"), config_name="default") # 新版hydra需要添加version_base=None
